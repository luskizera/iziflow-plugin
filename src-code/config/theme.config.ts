...
const semanticTokenDefinitions = {
  ...
  chips: {error: {fill:"{ruby.4}",text:"{ruby.11}"},default: {fill:"{accent.4}",text:"{accent.11}"}},
  node_startend: {fill:"{neutral.2}", "start-text":"{grass.9}", "end-text":"{ruby.9}", border:"{neutral.6}"},
