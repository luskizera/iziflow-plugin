...
export function App() {
  ...
  return (
    <TooltipProvider delayDuration={100}>
      <div className={cn("flex flex-col h-[500px] bg-background text-foreground pt-4 pb-1 px-4 gap-5", uiTheme)}>
        {/* Header */}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-grow min-h-0">
          ...
          <TabsContent value="generator" className="mt-5 flex flex-1 flex-col gap-5 data-[state=inactive]:hidden">
            {/* Textarea */}
            <Textarea
...
<footer className="flex flex-row sm:flex-row items-center justify-between gap-4">
  <p className="text-xs text-muted-foreground">Made with ❤️ by IziTools</p>
  <div className="flex items-center gap-3">
    <Button variant="ghost" size="sm" className="text-xs text-muted-foreground font-medium h-8 px-3" asChild>
      <a href="https://chatgpt.com/g/g-680800ab82a88191afc106220253ff30-iziflow-assistant" target="_blank" rel="noopener noreferrer">
        IziFlow Copilot
      </a>
    </Button>
    <Button variant="ghost" size="sm" className="text-xs text-muted-foreground font-medium h-8 px-3" asChild>
      <a href="https://github.com/luskizera/iziflow-plugin" target="_blank" rel="noopener noreferrer">
        GitHub
      </a>
    </Button>
    <Button variant="ghost" size="sm" className="text-xs text-muted-foreground font-medium h-8 px-3" asChild>
      <a href="https://www.izitools.xyz" target="_blank" rel="noopener noreferrer">
        iziTools Website
      </a>
    </Button>
  </div>
