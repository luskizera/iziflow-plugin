...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 w-96 items-center justify-center rounded-lg bg-card border p-1 space-x-1 text-muted-foreground",
      className
    )}
    {...props}
  />
